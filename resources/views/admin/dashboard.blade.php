...
<div class="container-fluid">
    <div class="row">
        <!-- Tổng số bài viết Card -->
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Tổng số bài viết</div>
        ...
        <!-- Bài viết đang chờ duyệt Card -->
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Bài viết đang chờ duyệt</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $pendingArticles }}</div>
                        </div>
                        <div class="col-auto">
